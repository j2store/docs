...
![paypal](../../images/payment-methods/paypal-payment-plugin/paypal_dashboard.png)
...
![auto currency](../../images/payment-methods/paypal-payment-plugin/auto-currency.png)
...
![new currency](../../images/payment-methods/paypal-payment-plugin/new-currency.png)
* Currency Name: USD
* Currency Code: USD
* Currency Symbol: $
* Decimal places: 2
...
![currency code](../../images/payment-methods/paypal-payment-plugin/currency-code.png)
...
![paypal docs](../../images/payment-methods/paypal-payment-plugin/paypal-docs-arrtibutes-restriction.png)
...
![waf exception](../../images/payment-methods/paypal-payment-plugin/waf-exception.png)
